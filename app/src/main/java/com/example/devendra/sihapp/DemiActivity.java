...
public class DemiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AuthUI.getInstance().signOut(DemiActivity.this);
            }
        });
        //Auth
            ...
            public void onAuthStateChanged(@NonNull final FirebaseAuth firebaseAuth) {
                ...
                if(user != null)
                {
                    ...
                    if (user.getDisplayName()==null || user.getDisplayName().equals("")) {
                        ...
                        LayoutInflater layoutInflaterAndroid = LayoutInflater.from(DemiActivity.this);
                        View mView = layoutInflaterAndroid.inflate(R.layout.pop_layout, null, false);
                        AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(DemiActivity.this);
...
//                                        Toast.makeText(MainActivity.this, input, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(DemiActivity.this, "Welcome: " + user.getDisplayName(), Toast.LENGTH_SHORT).show();
        ...
        Intent in = new Intent(DemiActivity.this , MainActivity.class);
        startActivity(in);
        finish();
